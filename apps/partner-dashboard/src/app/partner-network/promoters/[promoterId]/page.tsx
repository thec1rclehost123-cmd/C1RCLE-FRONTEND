...
export default async function PartnerNetworkPromoterPage({ params }: { readonly params: Promise<{ promoterId: string }> }) {
  ...
  return (
    <PartnerNetworkAccess>
      <DashboardPageHeader eyebrow="Private Partner Network" title="Promoter profile" description="Performance and collaboration signals for verified venues and hosts. Financial data is intentionally excluded." actions={<DashboardButton href="/" tone="secondary">Back to dashboard</DashboardButton>} />
