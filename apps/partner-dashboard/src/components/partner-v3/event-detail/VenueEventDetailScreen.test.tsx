...
describe('VenueEventDetailScreen', () => {
  it('renders the Venue HTML detail hierarchy and routes deeper controls', async () => {
    ...
    expect(screen.getByRole('link', { name: /All events/ })).toHaveAttribute('href', '/partner/venue/events');
    ...
    expect(screen.getByRole('link', { name: 'Edit' })).toHaveAttribute('href', '/partner/venue/events/neon-nights-afrobeats/edit');
    expect(screen.getByRole('link', { name: 'Door Mode' })).toHaveAttribute('href', '/partner/venue/door');
    expect(screen.getByRole('link', { name: "Who's coming" })).toHaveAttribute('href', '/partner/venue/events/neon-nights-afrobeats/guests');
    expect(screen.getByRole('link', { name: 'Tonight' })).toHaveAttribute('href', '/partner/venue/events/neon-nights-afrobeats/tonight');
    expect(screen.getByRole('link', { name: 'Promoters' })).toHaveAttribute('href', '/partner/venue/events/neon-nights-afrobeats/promoters');
    expect(screen.getByRole('link', { name: 'Funnel' })).toHaveAttribute('href', '/partner/venue/events/neon-nights-afrobeats/sales?view=funnel');
    expect(screen.getByRole('link', { name: 'Revenue' })).toHaveAttribute('href', '/partner/venue/events/neon-nights-afrobeats/sales?view=revenue');
