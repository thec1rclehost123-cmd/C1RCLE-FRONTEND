...
const headings: Record<AuthStep, { eyebrow: string; title: string; accent: string; subtitle: string }> = {
  methods: {
...
function GoogleMark() {
  return (
    <svg className="h-5 w-5" viewBox="0 0 24 24" aria-hidden="true">
      ...
      <path fill="#FBBC05" d="M5.84 14.1A6.62 6.62 0 0 1 5.49 12c0-.73.13-1.43.35-2.1V7.08H2.18A11 11 0 0 0 1 12c0 1.78.43 3.45 1.18 4.94l3.66-2.84Z" />
      <path fill="#EA4335" d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15A10.6 10.6 0 0 0 12 1a11 11 0 0 0-9.82 6.07l3.66 2.84A6.56 6.56 0 0 1 12 5.38Z" />
    </svg>
  );
}
...
export function LoginFormCard({
  ...
  const selectedCountry = fixture.supportedCountries.find((country) => country.code === form.country);
          ...
          <div className="space-y-4">
            ...
            >
              <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" aria-hidden="true">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" d="M7 2h10a2 2 0 0 1 2 2v16a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2Zm3 17h4" />
              </svg>
              Continue with phone number
            </button>
            <div className="flex items-center gap-3 py-3">
              <div className="h-px flex-1 bg-white/10" />
              <span className="text-[9px] font-black uppercase tracking-[0.25em] text-white/30">OR</span>
              <div className="h-px flex-1 bg-white/10" />
            </div>
            <Link
              href="/explore"
          ...
          <form onSubmit={onSubmit} className="space-y-6">
            {step === 'phone' && (
              <PhoneStep
                ...
                phone={form.phone}
                onCountryChange={(value) => { onFormChange('country', value); }}
            ...
            {step === 'verify_otp' && (
              <OtpVerifyStep
                phone={fullPhone}
                otp={form.otp}
                onOtpChange={(value) => { onFormChange('otp', value); }}
            ...
            {step === 'identity' && (
              <div className="space-y-5">
                <div className="space-y-2">
                  <label htmlFor="preferred-name" className="block text-[10px] font-black uppercase tracking-[0.25em] text-white/65">
                    Preferred name
                  </label>
                  <input
                    id="preferred-name"
                ...
                <div className="space-y-2">
                  <label htmlFor="date-of-birth" className="block text-[10px] font-black uppercase tracking-[0.25em] text-white/65">
                    Date of birth
                  </label>
                  <input
                    id="date-of-birth"
                  ...
                  />
                  <p className="text-[9px] font-bold uppercase tracking-[0.16em] text-white/35">You must be 18 or older.</p>
                </div>
              </div>
            )}
            ...
            {step === 'city' && (
              <CitySelectorStep
                ...
                onSelectCity={(value) => { onFormChange('city', value); }}
              />
            )}
            ...
            {step === 'tastes' && (
              <ChoiceGrid
                ...
                onToggle={(value) => { onToggleChoice('tastes', value); }}
              />
            )}
            ...
            {step === 'intent' && (
              <ChoiceGrid
                ...
                onToggle={(value) => { onToggleChoice('intents', value); }}
              />
            )}
